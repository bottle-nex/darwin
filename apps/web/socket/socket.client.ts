...
import { is_intentional_closure } from "@trydarwin/types";
...
export default class WebSocketClient {
    ...
    private initialize_connection() {
        ...
        this.ws.onmessage = (event: MessageEvent<string>) => {
            try {
                const parsed = JSON.parse(event.data) as OutboundSocketMessage;
    ...
    private handle_incoming_message(message: OutboundSocketMessage) {
    ...
    public subscribe(type: OutboundSocketMessageType, handler: MessageHandler) {
    ...
    public unsubscribe(type: OutboundSocketMessageType, handler: MessageHandler) {
    ...
    public send(message: InboundSocketMessage) {
