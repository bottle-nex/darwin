  ...
  return (
    <section className="w-full pt-40 pb-24">
      <div className="mx-auto flex w-full max-w-2xl flex-col items-center px-6 text-center">
        ...
        <h1
          className="font-arimo mt-4 text-5xl leading-[1.1] tracking-tight md:text-6xl text-snow"
        >
        ...
        <div className="mt-8 flex items-center gap-3">
          <Button
            className="pl-3! pr-2! h-8 rounded-sm bg-white"
          >
            Get Started
            <MdChevronRight className="text-ink!" />
          </Button>
          <Button
            className="bg-snow/10! text-snow rounded-sm pl-3 pr-2 h-8"
          >
            See how it works
