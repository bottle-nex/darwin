...
export const ATTACHMENT_ROW =
    "flex w-full items-center gap-2 rounded-md px-0 py-1.5 text-left text-[13.5px] text-neutral-200 no-underline transition-colors hover:bg-overlay/5";
...
export const STACKED_CAPSULE =
    "w-full rounded-md bg-transparent px-1.5 py-1.5 text-[13.5px] text-neutral-200 ring-0 [&_svg]:size-[18px] hover:bg-overlay/5 disabled:cursor-default disabled:text-neutral-400 disabled:hover:bg-transparent";
...
export const PRIORITY_OPTIONS: PriorityOption[] = [
    { value: "none", label: "No priority", icon: NoPriorityIcon, rank: 0 },
    {
        ...
        rank: 1,
        iconClassName: "size-3.25! text-danger",
    },
