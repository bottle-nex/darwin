...
export const CARD_SHELL =
    "rounded-md ring-[1px] ring-snow/5 bg-snow/4 p-2.25 text-left hover:bg-snow/6 group-data-[selected=true]/card:border-primary/7 group-data-[selected=true]/card:bg-[#292B44] group-data-[selected=true]/card:hover:bg-[#292B44]";
