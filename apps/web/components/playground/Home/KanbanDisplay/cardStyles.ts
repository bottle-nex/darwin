...
export const CARD_SHELL =
    "rounded-md border border-snow/5 bg-snow/4 p-2.25 text-left hover:bg-primary/7 group-data-[selected=true]/card:border-primary/7 group-data-[selected=true]/card:bg-primary/7";
