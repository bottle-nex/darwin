        ...
        <SettingsHeroCard>
            <HeroPanel className="-bottom-6 -left-8 w-88 -rotate-6" accent>
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[13.5px] font-medium text-snow/90">Project</span>
                </div>
                <div className="mt-3.5 flex flex-col gap-2">
                    <HeroInput>Nocturn</HeroInput>
                    <HeroInput className="font-mono text-snow/55">nocturn</HeroInput>
                </div>
            </HeroPanel>
            <HeroPanel className="-top-3 left-60 w-80 rotate-2">
                ...
                <div className="mt-3.5 flex items-center justify-between gap-3">
                    <span className="text-[13px] text-snow/70">Product Diff</span>
                    <HeroSwitch on />
                </div>
            </HeroPanel>
            <HeroPanel className="top-16 -right-8 w-80 -rotate-2">
                ...
                <div className="mt-3 flex items-center justify-between gap-3">
                    <span className="flex flex-col gap-1.5">
                        <span className="text-[13px] text-snow/80">Delete this project</span>
                        <HeroLine className="w-28" />
                    </span>
                    <HeroChip className="bg-brick/50 text-brick-foreground">Delete</HeroChip>
                </div>
                <div className="mt-3.5 flex items-center justify-between gap-3">
                    <span className="text-[13px] text-snow/70">Transfer ownership</span>
