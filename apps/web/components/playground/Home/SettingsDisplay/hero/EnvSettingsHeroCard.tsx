        ...
        <SettingsHeroCard>
            <HeroPanel className="-bottom-6 -left-8 w-100 -rotate-5" accent>
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[13.5px] font-medium text-snow/90">
                        Environment variables
                    </span>
                </div>
                <div className="mt-4 flex flex-col gap-3 font-mono text-[12.5px]">
                    <div className="flex items-center justify-between gap-4">
                        <span className="text-snow/80">DATABASE_URL</span>
                        <span className="text-snow/30">••••••••••••••••</span>
                    </div>
                    <div className="flex items-center justify-between gap-4">
                        <span className="text-snow/80">RESEND_API_KEY</span>
                        <span className="text-snow/30">••••••••••</span>
                    </div>
                    <div className="flex items-center justify-between gap-4">
                        <span className="text-snow/80">SERVER_JWT_SECRET</span>
                        <span className="text-snow/30">••••••••••••</span>
                    </div>
                </div>
            </HeroPanel>
            <HeroPanel className="-top-3 left-60 w-80 rotate-2">
                ...
                <div className="mt-3 flex gap-2">
                    <HeroInput className="flex-1 font-mono text-snow/45">KEY</HeroInput>
                    <HeroInput className="flex-1 font-mono text-snow/45">value</HeroInput>
                </div>
