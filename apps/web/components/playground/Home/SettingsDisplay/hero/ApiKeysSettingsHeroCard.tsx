        ...
        <SettingsHeroCard>
            <HeroPanel className="-bottom-6 -left-8 w-100 -rotate-5" accent>
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[13.5px] font-medium text-overlay/90">API keys</span>
                </div>
                <div className="mt-4 flex flex-col gap-3">
                    <div className="flex items-center justify-between gap-4">
                        <span className="flex flex-col gap-1">
                            <span className="text-[13px] text-overlay/80">Nocturn local</span>
                            <span className="font-mono text-[12px] text-overlay/35">
                                mch_live_dx5v1xxx••••
                            </span>
                        </span>
                        <HeroChip className="text-danger">Revoke</HeroChip>
                    </div>
                    <div className="flex items-center justify-between gap-4">
                        <span className="flex flex-col gap-1">
                            <span className="text-[13px] text-overlay/80">Nocturn CI</span>
                            <span className="font-mono text-[12px] text-overlay/35">
                                mch_live_dx5v0xxx••••
                            </span>
                        </span>
            ...
            <HeroPanel className="-top-3 left-60 w-80 rotate-2">
                ...
                <div className="mt-3 flex gap-2">
                    <HeroInput className="flex-1 text-overlay/45">e.g. Claude Desktop</HeroInput>
            ...
            <HeroPanel className="top-16 -right-10 w-76 -rotate-2">
                ...
                <div className="mt-2.5 flex items-center justify-between gap-3">
                    <span className="truncate font-mono text-[12px] text-overlay/55">
