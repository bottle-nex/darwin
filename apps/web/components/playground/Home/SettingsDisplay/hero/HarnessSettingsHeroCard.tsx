        ...
        <SettingsHeroCard>
            <HeroPanel className="-bottom-6 -left-8 w-92 -rotate-6" accent>
                <div className="flex items-center gap-3">
                    ...
                    <span className="flex flex-col">
                        ...
                        <span className="text-[12px] text-overlay/45">
                            Runs inside a sandboxed runner
                        </span>
                    </span>
                </div>
                <div className="mt-4 flex items-center justify-between gap-3">
                    <span className="text-[13px] text-overlay/70">Default model</span>
                    <HeroInput className="w-fit gap-2 py-1.5 font-mono text-[12.5px]">
                        claude-sonnet-4.5
                        <span className="text-overlay/35">⌄</span>
                    </HeroInput>
                </div>
                <div className="mt-3 flex items-center justify-between gap-3">
                    <span className="text-[13px] text-overlay/70">Harness</span>
            ...
            <HeroPanel className="top-16 -right-10 w-72 -rotate-2">
                <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-[12.5px] text-overlay/70">agent-3 claimed MAT-142</span>
                </div>
                <div className="mt-3 flex items-center gap-2.5">
                    <span className="size-1.5 rounded-full bg-primary" />
                    <span className="text-[12.5px] text-overlay/70">agent-1 opened PR #73</span>
                </div>
            </HeroPanel>
        </SettingsHeroCard>
    );
