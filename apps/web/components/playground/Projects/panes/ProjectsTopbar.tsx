...
/**
 * Header for the Projects surface — mirrors the Kanban topbar. The title is a
 * searchable project switcher; the right side toggles the settings panel.
 */
export default function ProjectsTopbar({
    ...
    return (
        <header className="flex h-11 shrink-0 items-center justify-between gap-2 border-b border-white/5 px-3">
