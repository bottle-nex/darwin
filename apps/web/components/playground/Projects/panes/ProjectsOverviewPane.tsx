...
/**
 * Default landing pane for the Projects surface (and the workspace at large) —
 * the "invite people" prompt carried over from the original empty state.
 */
export default function ProjectsOverviewPane() {
    return (
        <div className="flex flex-1 flex-col items-center justify-center px-6 pb-16 text-center">
            ...
            <p className="mt-1 text-[13px] text-neutral-500">Collaboration is one invite away.</p>
            <Button
                size="sm"
