 ...
 */
const FLOW_PATHS = [
    "M100 80 V190 Q100 202 112 202 H468 Q480 202 480 214 V300",
    "M300 80 V150 Q300 162 312 162 H478 Q490 162 490 174 V300",
    "M500 80 V300",
    "M700 80 V150 Q700 162 688 162 H522 Q510 162 510 174 V300",
    "M900 80 V190 Q900 202 888 202 H532 Q520 202 520 214 V300",
];

const BUS_SEGMENTS = "M0 1 H36 M166 1 H234 M366 1 H434 M566 1 H634 M766 1 H834 M964 1 H1000";
...
function CircuitBoard() {
    ...
    return (
        <svg
            ...
            fill="none"
            className="pointer-events-none absolute top-[184px] left-6 hidden h-[calc(100%-184px)] w-[calc(100%-48px)] md:block"
        >
...
export default function IntegrationsHero() {
    ...
    return (
        <section className="relative overflow-hidden rounded-2xl font-grotesk pt-10">
            ...
            <div className="relative mx-auto max-w-6xl px-6">
                <CircuitBoard />
                <div className="relative grid grid-cols-5 justify-items-center pt-20 md:pt-28">
                    {TILES.map((tile, i) => (
                        <motion.div
                            key={tile.name}
                ...
                <div aria-hidden className="hidden md:block md:h-72" />
            ...
            <div className="relative mx-auto flex max-w-4xl flex-col items-center px-6 pt-52 pb-28 text-center md:pt-20 md:pb-36">
                <p className="tracking-[0.2em] text-primary uppercase font-mono md:text-[13px]">
                    Integrations
                </p>
                <h1 className="mt-4 text-[clamp(2rem,4.6vw,3.25rem)] leading-[1.12] font-medium tracking-tight text-snow/90">
                    Your stack, wired into matcha
                </h1>
                <p className="mt-5 max-w-xl leading-relaxed text-neutral-400 md:text-[17px]">
                    Issues stream in from GitHub, Notion, Linear, Slack and Jira. Agents pick them
                    up, ship the fix, and send the pull request back where it came from.
                </p>
            </div>
        </section>
    );
