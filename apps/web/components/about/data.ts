...
export const story: StoryContent = {
    ...
    paragraphs: [
        "matcha started the way most tools do — with a backlog nobody had time for. We kept a tidy board, we wrote good issues, and then we watched them sit there, waiting for an engineer with a free afternoon that never came. The tracker kept score while nothing moved.",
...
export const founders: Founder[] = [
    ...
    },
    {
        ...
        bio: [
            ...
            "And then I met Rishi and Piyush, and aah, they pushed me to limits. They always say “do it clean or don't do it.” At the time, I was building some small projects, didn't know why. Then in July, we sat in a meeting and Rishi said, “let's build something real, something together.” That's how matcha began.",
            "From day one, matcha was built with a strong focus on user experience, while staying equally committed to developer experience. It wasn't easy, and still isn't, but it's worth it. As a team, we haven't reached great heights yet, but we've built something just as important — trust. And soon, something we've been working on will be out in the market.",
        ],
    },
    {
        name: "Piyush Raj",
        ...
        bio: [
            ...
            "Around mid-2025, I met Rishi and Anjan. We clicked, and naturally decided to build something together. That's how matcha came to life. We spent a lot of time obsessing over the small stuff, especially the edge cases most people don't think about. Turns out, that's where the fun is.",
            "I've always liked making things feel just right. If a picky person looks at something I made and likes it, I take that as a win. With matcha, we tried to keep that same vibe — clean visuals, thoughtful structure, and attention to the details that quietly matter. Us devs have brought it this far together, and honestly, we're just getting started.",
        ],
    },
];
