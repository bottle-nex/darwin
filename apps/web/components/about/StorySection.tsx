        ...
        <section className="border-t border-white/10 bg-cement">
            <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-12 px-6 py-24 lg:grid-cols-12">
                ...
                <Reveal delay={0.1} className="flex flex-col gap-14 lg:col-span-7 lg:pt-2">
                    <div className="flex flex-col gap-10 leading-relaxed text-neutral-400 md:flex-row">
                        <p className="flex-1">{story.paragraphs[0]}</p>
                        <p className="flex-1">{story.paragraphs[1]}</p>
                    </div>
                    <div className="flex items-end justify-between gap-10">
                        <p className="max-w-2xl text-3xl font-extralight leading-snug text-neutral-600">
                            {story.pullQuote.muted}{" "}
                            <span className="text-neutral-200">{story.pullQuote.emphasis}</span>
                        </p>
                        <FloatingCard
                            inView
