...
export default function FeatureCard({
    ...
    return (
        <div
            className={cn(
                "relative overflow-hidden rounded-xl transition-all duration-300 ease-out hover:z-10 hover:shadow-sm hover:shadow-neutral-800 border border-neutral-200",
