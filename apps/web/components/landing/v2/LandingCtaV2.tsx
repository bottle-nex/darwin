        ...
        <section className="relative overflow-hidden border-t border-neutral-200">
            ...
            <Reveal className="relative mx-auto flex w-full max-w-7xl flex-col items-center gap-6 px-6 py-24 md:py-40">
                ...
                <h2 className="text-center text-4xl font-light leading-[1.08] tracking-tight text-neutral-900 sm:text-6xl sm:leading-[1.02] md:text-7xl">
                    ...
                    <span className="text-neutral-400">Neither do agents.</span>
                </h2>
                <p className="max-w-xl text-center leading-relaxed text-neutral-600">
                ...
                <div
                    className={cn(
                        "flex flex-wrap items-center justify-center gap-3 pt-6 text-[12px] uppercase tracking-wide text-neutral-500 sm:gap-4",
                        azeretMono.className,
                    )}
                >
