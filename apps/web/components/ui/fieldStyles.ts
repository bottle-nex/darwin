...
export const DIALOG_TITLE_FIELD = "w-full text-2xl leading-tight font-semibold text-neutral-100";

export const FIELD_LABEL = "text-[12px] font-medium text-overlay/85";
