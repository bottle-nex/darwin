...
function DialogOverlay({
    ...
    return (
        <DialogPrimitive.Overlay
            ...
            className={cn(
                "surface-scrim fixed inset-0 z-50 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:animate-in data-[state=open]:fade-in-0",
                className,
            )}
            {...props}
        />
...
export const DIALOG_COMPOSER_SURFACE = "rounded-3xl border border-overlay/5 bg-graphite";
    ...
    return (
        <DialogPortal data-slot="dialog-portal">
            ...
            <DialogPrimitive.Content
                ...
                className={cn(
                    "fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg gradient-border p-6 shadow-lg duration-200 outline-none data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 sm:max-w-lg",
            ...
            >
                ...
                {showCloseButton && (
                    ...
                    >
                        <CloseIcon className="text-overlay" />
