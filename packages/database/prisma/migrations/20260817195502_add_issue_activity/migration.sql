...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('IssueCreated', 'IssueReopened', 'IssueResolved', 'IssueCancelled', 'IssueArchived', 'IssueDeleted', 'StatusChanged', 'PriorityChanged', 'TitleChanged', 'DescriptionChanged', 'AssigneeAdded', 'AssigneeRemoved', 'LabelAdded', 'LabelRemoved', 'DatesChanged', 'ColumnChanged', 'SpecializationChanged', 'RelationAdded', 'RelationRemoved', 'SplitIntoSubIssues', 'Queued', 'Routed', 'Reprioritized', 'Preempted', 'Starved', 'RunStarted', 'RunCompleted', 'AttemptFailed', 'RunAborted', 'WorkerHandoff', 'WorkerDied', 'HumanTookOver', 'HandedBackToHuman', 'BugReproduced', 'BugNotReproduced', 'BuildResult', 'TestResult', 'AcceptanceChecked', 'BranchCreated', 'CommitsPushed', 'PrOpened', 'PrReviewReceived', 'PrFeedbackAddressed', 'PrChecksFailed', 'PrRebased', 'PrMerged', 'PrClosed', 'PrReverted', 'ExternalMessageSent', 'ExternalIssueOpened', 'ExternalDocUpdated', 'OncallPaged', 'ScopeRequested', 'ScopeGranted', 'ScopeDenied', 'GuardrailHit', 'SecretAccessed', 'BudgetThresholdCrossed', 'BudgetExceeded', 'AttachmentAdded');
