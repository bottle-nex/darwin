    ...
    return (
        ...
        >
            <Button
                ...
                aria-expanded={open}
                className="absolute top-[0.35rem] left-0 flex size-4 cursor-pointer items-center justify-center rounded-[3px] text-neutral-500 transition-colors hover:bg-overlay/10 hover:text-neutral-200"
            >
                <DropdownCaretIcon
