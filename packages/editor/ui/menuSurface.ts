...
export const MENU_SURFACE = cn(
    "z-50 min-w-[10rem] rounded-lg border border-overlay/5 p-1 shadow-[0_8px_24px_rgba(0,0,0,0.45)] duration-75 animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95",
    "bg-graphite",
);
...
export const MENU_ITEM =
    "flex cursor-pointer items-center gap-2 rounded-sm px-2.5 py-1.5 text-[13.5px] text-overlay/90 outline-none select-none data-highlighted:bg-overlay/8 data-highlighted:text-neutral-100 data-[selected=true]:bg-overlay/8 data-[selected=true]:text-neutral-100 aria-disabled:pointer-events-none aria-disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:shrink-0";
