...
const PROSE_CLASS = [
    ...
    "[&>*+*]:mt-6",
    "[&_h2]:mt-14 [&_h2]:text-[1.55rem] [&_h2]:font-medium [&_h2]:leading-snug [&_h2]:tracking-tight [&_h2]:text-overlay",
    "[&_h3]:mt-10 [&_h3]:text-[1.15rem] [&_h3]:font-medium [&_h3]:text-overlay",
    "[&_h2+*]:mt-4 [&_h3+*]:mt-3",
    "[&_strong]:font-medium [&_strong]:text-overlay",
    ...
    "[&_code]:rounded [&_code]:bg-overlay/6 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-[14px] [&_code]:text-mist",
